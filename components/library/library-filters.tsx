    ...
    <div className="space-y-4">
      ...
      {showFilters && (
        <div className="bg-gray-50 rounded-lg p-4 space-y-4">
          {/* Categories */}
          <div>
            <h4 className="text-sm font-medium text-gray-700 mb-2">Categories in Your Library</h4>
            <div className="flex flex-wrap gap-2">
              {availableCategories.length > 0 ? (
                ...
                <p className="text-sm text-gray-500">No categories available in your library</p>
              )}
            </div>
          </div>
        </div>
